...
y_pred <- get_softmax(1:nrow(label_matrix),1:nrow(label_matrix),model,features_list,y_all,get_plot = T,epochs = 30,batch_size = 32,validation_split = 0.05)
png(filename = '~/performance_rmsprop_150.png',width = 1080,height = 25600)
plot(y_pred)
dev.off()
