...
performance_file_name =  '~/Dropbox/MU/workspace/DeepGRN/syn_network_prediction/syn_model_original/performance/performance_multiout_0.1_batchNorm.tsv'
...
# construct model
model = utils_test.get_multiout_model(feature_input_ndarray.shape,output_dim,num_filters,num_conv2d_layers,num_cat,batchnorm = True)
