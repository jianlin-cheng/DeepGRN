...
performance_file_name =  '/storage/htc/bdm/ccm3x/syn_network_prediction/syn_model/performance/pathway/performance_sub0.6.tsv'
...
input_dim_df = utils_test.pd.read_csv('/storage/htc/bdm/ccm3x/syn_network_prediction/syn_model/subnetworks/sub_0.6.csv')
