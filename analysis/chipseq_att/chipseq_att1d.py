...
cell_name = predict_region.columns.values[3]
att_avg_out = '/home/chen/data/deepGRN/results/results_revision202001/chipseq_att/single/data/'+tf_name+'_'+cell_name+'_fw_att.csv'
chipseq_out = '/home/chen/data/deepGRN/results/results_revision202001/chipseq_att/single/data/'+tf_name+'_'+cell_name+'_fw_chipseq.csv'
pos_out = '/home/chen/data/deepGRN/results/results_revision202001/chipseq_att/single/data/'+tf_name+'_'+cell_name+'_fw_pos.csv'
...
att_avg_layer = get_model.Softmax(axis=1,name='avg_output')
fw_output = model.get_layer('dropout_2').get_output_at(0)
...
att_len = att_model_fw.get_output_shape_at(0)[1]
