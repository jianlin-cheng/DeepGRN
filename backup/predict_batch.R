...
model_path = '/storage/htc/bdm/ccm3x/deepGRN/results/set1/models'
label_final_path = '/storage/htc/bdm/ccm3x/deepGRN/raw/label/final/'
out_path = '/storage/htc/bdm/ccm3x/deepGRN/results/set1/predictions/'
...
for (i in model_files){
  ...
  for(cell_name in cell_names){
    system(paste('sbatch ~/configs/py_cpu_sub.sbatch python /storage/htc/bdm/ccm3x/deepGRN/src/model_predict.py',i,cell_name,out_path))
  }
}
