...
For detailed instructions of data preparation, please refer to [Prepare label data for custom training](../README.md#Prepare-your-input-data-for-prediction) and [Prepare label data for custom training](../README.md#Prepare-label-data-for-custom-training)