...
out_path = '/home/chen/Dropbox/MU/workspace/encode_dream/plots/model_architures/best_models/'

model_file = model_path+'factornet_attention.REST.1.401.unique35True.RNAseqTrue.GencodeTrue.h5'
out_file = out_path+'REST.png'

model = load_model(model_file,custom_objects={'Attention1D': Attention1D})
plot_model(model,show_shapes=True,show_layer_names=True,to_file=out_file)
