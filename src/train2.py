...
def main():
    ...
    for i in range(epochs):
        ...
        file.write(str(i)+','+str(history.history['loss'][0])+','+str(history.history['acc'][0])+','+str(current_auroc)+','+str(current_auprc)+'\n') 
        file.close() 
        ...
        if current_auprc > best_auprc:
            ...
            wait_iter=0
            model.save(re.sub('.h5','.epoch'+str(i)+'.h5',output_model))
