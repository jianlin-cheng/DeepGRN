...
if __name__ == '__main__':
    ...
    m1 = make_model_attention('attention_before_lstm',L=1002,num_meta=8,num_conv = 0,num_denselayer=0,num_lstm=0)
    m2 = make_model_attention('attention_after_lstm',L=1002,num_meta=8,num_conv = 1,num_denselayer=0,num_lstm=1)
    m4 = make_model_attention('attention1d_after_lstm',L=1002,num_meta=8,num_conv = 0,num_denselayer=0,num_lstm=0)
    ...
    plot_model(m4,show_shapes=True,show_layer_names=False,to_file='attention1d_after_lstm.png')
    plot_model(m1,show_shapes=True,show_layer_names=False,to_file='attention_before_lstm.png')
    plot_model(m2,show_shapes=True,show_layer_names=False,to_file='attention_after_lstm.png')
