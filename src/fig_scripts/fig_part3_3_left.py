...
tf_name = 'CTCF'
model_file = '/home/chen/Dropbox/MU/workspace/encode_dream/data/best_models/attention_after_lstm.CTCF.1.401.unique35True.RNAseqTrue.GencodeTrue.h5'
...
label_region = label_region[label_region['chr']==chr_id]
...
out_dir = '/home/chen/Dropbox/MU/workspace/encode_dream/plots/interpretation/fig5/'
os.mkdir(out_dir)
...
os.system("Rscript /home/chen/Dropbox/MU/workspace/encode_dream/src/viz/weight_interpret_viz.R "+out_dir+' 1')